...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccount.setText(mLoginConfig.getAccount());
    ...
    private void attemptLogin() {
        ...
        doLogin(email, password, captchaCode);
    }

    private void doLogin(final String name, String psw, String captchaCode) {
        String date = "username=" + name + "&password=" + psw + "&grant_type=password" + "&captcha=" + captchaCode;
