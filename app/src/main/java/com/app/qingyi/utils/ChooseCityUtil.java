...
import com.app.qingyi.models.CityBean;
...
public class ChooseCityUtil implements View.OnClickListener, NumberPicker.OnValueChangeListener {
    ...
    public void createDialog(Context context, String[] oldCityArray, ChooseCityInterface cityInterface) {
        ...
        bean = GsonUtils.JsonObjectToBean(GsonUtils.getRootJsonObject(getData(context)), CityBean.class);
    ...
    private String getData(Context context){
        return  getFromAssets("city.json",context);
    }
